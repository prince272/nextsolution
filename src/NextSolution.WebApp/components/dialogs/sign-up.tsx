...
export const SignUpModal: FC<SignUpProps> = ({ opened, onClose }) => {
  ...
  return (
    <Modal isKeyboardDismissDisabled={true} isOpen={opened} onClose={() => onClose()} as="form" onSubmit={form.handleSubmit(onSignUp)}>
      <ModalContent>
        ...
        <ModalBody>
          <div className={cn("grid grid-cols-12 gap-x-5 gap-y-5 pb-2.5", method != "credentials" && "hidden")}>
            ...
            />
            <Button color="primary" className="col-span-12" onPress={() => form.handleSubmit(onSignUp)()} isLoading={status.action == "submitting"}>
              Sign up
            </Button>
