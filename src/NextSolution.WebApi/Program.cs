...
using NextSolution.WebApi.Data;
using NextSolution.WebApi.Providers.Messaging.MailKit;
using NextSolution.WebApi.Middlewares;
using NextSolution.WebApi.Extensions;
using NextSolution.WebApi.Providers.SwaggerGen;
using NextSolution.WebApi.Helpers;
using NextSolution.WebApi.Providers.Validation;
using NextSolution.WebApi.Providers.Messaging.Twilio;
using NextSolution.WebApi.Providers.JwtBearer;
using NextSolution.WebApi.Providers.ViewRender;
